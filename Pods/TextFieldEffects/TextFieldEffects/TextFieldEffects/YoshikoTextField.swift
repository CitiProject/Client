...
@IBDesignable open class YoshikoTextField: TextFieldEffects {
     ...
     */
    @IBInspectable dynamic open var activeBorderColor: UIColor = UIColor.clear {
        didSet {
            updateBorder()
            updateBackground()
            updatePlaceholder()
    ...
    /**
     ...
     This property applies a color to the edges of the control. The default value for this property is a clear color.
     */
    @IBInspectable dynamic open var inactiveBorderColor: UIColor = UIColor.clear {
        didSet {
            updateBorder()
            updateBackground()
            updatePlaceholder()
     ...
     */
    @IBInspectable dynamic open var activeBackgroundColor: UIColor = UIColor.clear {
        didSet {
            updateBackground()
        }
    }
     ...
     */
    @IBInspectable dynamic open var placeholderColor: UIColor = UIColor.darkGray {
        didSet {
            updatePlaceholder()
        }
    }
